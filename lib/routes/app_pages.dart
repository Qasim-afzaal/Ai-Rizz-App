...
import 'package:sparkd/pages/start/main_screen/first_screen.dart';
import 'package:sparkd/pages/start/main_screen/first_screen_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: _Paths.INFO, page: () => const InfoPage(), binding: InfoBinding()),
        GetPage(name: _Paths.MAINPAGE, page: () => const MainPage(), binding: MainPageBinding()),
